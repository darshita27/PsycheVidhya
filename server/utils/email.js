...
async function sendEmail({ to, subject, html, text }) {
  const from = process.env.EMAIL_FROM || "PsycheVidhya <no-reply@psychevidhya.local>";
...
function bookingClientEmail(booking) {
  return {
    subject: "We received your session request — PsycheVidhya",
    text:
      `Hi ${booking.name},\n\n` +
      `Thank you for reaching out to PsycheVidhya. We've received your request for ` +
